<div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
    <form wire:submit="save" class="space-y-6">
        ...
        <div>
            ...
            <x-text-input wire:model="sectors" id="sectors" type="text" class="mt-1 block w-full" placeholder="Education, Healthcare, Charity" />
        ...
        <div>
            ...
            <x-text-input wire:model="size_bands" id="size_bands" type="text" class="mt-1 block w-full" placeholder="1-10, 11-50, 51-200" />
        ...
        <div class="flex items-center gap-4">
            <x-primary-button>{{ __('Create ICP') }}</x-primary-button>
