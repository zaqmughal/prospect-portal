<div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
    <form wire:submit="save" class="space-y-6">
        ...
        <div>
            <x-input-label for="angle" :value="__('Angle (e.g. accessibility_ux, modernisation)')" />
        ...
        <div>
            ...
            <textarea wire:model="dm_template" id="dm_template" rows="6" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 font-mono text-sm" required></textarea>
        ...
        <div>
            ...
            <textarea wire:model="email_template" id="email_template" rows="10" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 font-mono text-sm" required></textarea>
        ...
        <div class="flex items-center gap-4">
            <x-primary-button>{{ __('Create Playbook') }}</x-primary-button>
