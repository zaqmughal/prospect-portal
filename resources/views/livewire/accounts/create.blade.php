<div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
    <form wire:submit="save" class="space-y-6">
        ...
        <div>
            ...
            <x-text-input wire:model="url" id="url" type="url" class="mt-1 block w-full" placeholder="https://example.com" required />
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <x-text-input wire:model="sector" id="sector" type="text" class="mt-1 block w-full" placeholder="e.g. Education, Healthcare" />
        ...
        <div>
            ...
            <x-text-input wire:model="location" id="location" type="text" class="mt-1 block w-full" placeholder="e.g. London, UK" />
        ...
        <div class="flex items-center gap-4">
            ...
            <a href="{{ route('accounts.index') }}" class="text-gray-600 hover:text-gray-900" wire:navigate>Cancel</a>
        </div>
    </form>
</div>
